...
<div class="header">
    <div class="brand-name">🔥FEX EMOTE PRO🔥</div>
...
<div class="container">
    <div class="mode-container">
        <span class="mode-label">ONE CLICK MODE</span>
    ...
    <div id="uid-list-show" class="uid-display-area">Target UIDs: (None)</div>
    <button class="play-btn" onclick="sendRequest()">PLAY EMOTE</button>
    <div id="response"></div>

    <div class="select-title">SELECT EMOTE</div>
...
<script>
    ...
    async function sendRequest() {
        ...
        try {
            ...
            resDiv.innerText = "Emote Sent Successfully ✅";
        } catch (err) {
